...
system("sudo apt install -y tor iptables network-manager obfs4proxy bleachbit nyx xterm onionshare-cli firefox-esr torbrowser-launcher onionshare nscd secure-delete python3 python3-pip")
